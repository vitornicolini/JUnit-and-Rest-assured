...
public class ComprarPassagemSeIDE {
    ...
    public void comprarPassagem() {
        ...
        driver.manage().window().setSize(new Dimension(1728, 1011));
        ...
        driver.findElement(By.id("inputName")).sendKeys("vitor");
        driver.findElement(By.id("address")).click();
        driver.findElement(By.id("address")).sendKeys("rua mamao");
